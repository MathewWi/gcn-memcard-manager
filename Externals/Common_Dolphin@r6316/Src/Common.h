...
D:\Documents\Desktop\dol\mcm.try2>@set ErrorLevel=%ErrorLevel%

D:\Documents\Desktop\dol\mcm.try2>@rem Restore the original console codepage.

D:\Documents\Desktop\dol\mcm.try2>@chcp %cp_oem% > nul < nul
